...
base_dir = r"C:\Users\Atharva\OneDrive\Desktop\msrtc\backend\apps\crew-service"
...
# 2. Enums
enums_ts = """export enum CrewStatus {
  AVAILABLE = 'AVAILABLE',
  ASSIGNED = 'ASSIGNED',
...
"""
with open(os.path.join(src_dir, "crew/enums/crew.enums.ts"), "w", encoding="utf-8") as f: f.write(enums_ts)


# 3. DTOs
dto_ts = """import { IsString, IsNotEmpty, IsEnum, IsUUID, IsDateString } from 'class-validator';
...
"""
with open(os.path.join(src_dir, "crew/dto/crew.dto.ts"), "w", encoding="utf-8") as f: f.write(dto_ts)
...
export class JwtAuthGuard implements CanActivate {
  canActivate(context: ExecutionContext): boolean {
    ...
    // Mock user decoding
    request.user = { userId: '123e4567-e89b-12d3-a456-426614174000', roles: ['Driver', 'Conductor', 'Depot_Manager', 'HQ_Admin'] };
    return true;
  }
}
"""
...
print("Crew Service Phase 1 Scaffolded (DTOs, Enums, Guards, Prisma)")
