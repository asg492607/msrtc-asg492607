...
base_dir = r"C:\Users\Atharva\OneDrive\Desktop\msrtc\backend\apps\hq-service"
...
# 2. Enums
enums_ts = """export enum AlertSeverity {
  INFO = 'INFO',
  WARNING = 'WARNING',
  CRITICAL = 'CRITICAL',
}
...
"""
with open(os.path.join(src_dir, "hq/enums/hq.enums.ts"), "w", encoding="utf-8") as f: f.write(enums_ts)


# 3. DTOs
dto_ts = """import { IsString, IsNotEmpty, IsEnum, IsOptional, IsDateString } from 'class-validator';
...
"""
with open(os.path.join(src_dir, "hq/dto/hq.dto.ts"), "w", encoding="utf-8") as f: f.write(dto_ts)
...
export class JwtAuthGuard implements CanActivate {
  canActivate(context: ExecutionContext): boolean {
    ...
    // Mock user decoding
    request.user = { userId: '123e4567-e89b-12d3-a456-426614174000', roles: ['Executive', 'HQ_Admin', 'Regional_Admin'] };
    return true;
  }
}
"""
...
print("HQ Service Phase 1 Scaffolded (DTOs, Enums, Guards, Prisma)")
