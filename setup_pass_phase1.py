...
base_dir = r"C:\Users\Atharva\OneDrive\Desktop\msrtc\backend\apps\pass-service"
...
# 2. Enums
enums_ts = """export enum PassStatus {
  DRAFT = 'DRAFT',
  SUBMITTED = 'SUBMITTED',
...
"""
with open(os.path.join(src_dir, "pass/enums/pass.enums.ts"), "w", encoding="utf-8") as f: f.write(enums_ts)
...
"""
with open(os.path.join(src_dir, "pass/dto/pass.dto.ts"), "w", encoding="utf-8") as f: f.write(dto_ts)
...
export class JwtAuthGuard implements CanActivate {
  canActivate(context: ExecutionContext): boolean {
    ...
    // Mock user decoding
    request.user = { userId: '123e4567-e89b-12d3-a456-426614174000', roles: ['Passenger', 'Depot_Manager', 'Conductor'] };
    return true;
  }
}
"""
...
print("Pass Service Phase 1 Scaffolded (DTOs, Enums, Guards, Prisma)")
