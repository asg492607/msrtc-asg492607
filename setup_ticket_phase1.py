...
base_dir = r"C:\Users\Atharva\OneDrive\Desktop\msrtc\backend\apps\ticket-service"
src_dir = os.path.join(base_dir, "src")

# Ensure package.json has validation and qrcode
pkg_json = """{
  "name": "ticket-service",
  "version": "1.0.0",
  "private": true,
...
# 2. Enums
enums_ts = """export enum TicketStatus {
  GENERATED = 'GENERATED',
  ISSUED = 'ISSUED',
  USED = 'USED',
  CANCELLED = 'CANCELLED',
...
"""
with open(os.path.join(src_dir, "ticket/enums/ticket.enums.ts"), "w") as f: f.write(enums_ts)


# 3. DTOs
dto_ts = """import { IsString, IsNotEmpty, IsUUID } from 'class-validator';
...
"""
with open(os.path.join(src_dir, "ticket/dto/ticket.dto.ts"), "w") as f: f.write(dto_ts)
...
export class JwtAuthGuard implements CanActivate {
  canActivate(context: ExecutionContext): boolean {
    ...
    request.user = { userId: '123e4567-e89b-12d3-a456-426614174000', roles: ['Passenger', 'Admin', 'Conductor'] };
    return true;
  }
}
"""
...
print("Ticket Service Phase 1 Scaffolded (DTOs, Enums, Guards, Prisma)")
