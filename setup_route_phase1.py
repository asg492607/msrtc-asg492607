...
base_dir = r"C:\Users\Atharva\OneDrive\Desktop\msrtc\backend\apps\route-service"
...
# 2. DTOs
search_trip_dto = """import { IsString, IsNotEmpty, IsDateString, IsOptional } from 'class-validator';
...
"""
with open(os.path.join(src_dir, "trip/dto/search-trips.dto.ts"), "w") as f: f.write(search_trip_dto)


# 3. Exception Filter & Guards (Ported)
...
print("Route Service Phase 1 Scaffolded (DTOs, Guards, Prisma)")
