...
base_dir = r"C:\Users\Atharva\OneDrive\Desktop\msrtc\backend\apps\parcel-service"
...
# 2. Enums
enums_ts = """export enum ParcelStatus {
  BOOKED = 'BOOKED',
...
"""
with open(os.path.join(src_dir, "parcel/enums/parcel.enums.ts"), "w", encoding="utf-8") as f: f.write(enums_ts)


# 3. DTOs
dto_ts = """import { IsString, IsNotEmpty, IsNumber, IsOptional, MaxLength, Min, ValidateNested, IsArray, IsUUID } from 'class-validator';
...
"""
with open(os.path.join(src_dir, "parcel/dto/parcel.dto.ts"), "w", encoding="utf-8") as f: f.write(dto_ts)
...
export class JwtAuthGuard implements CanActivate {
  canActivate(context: ExecutionContext): boolean {
    ...
    // Mock user decoding
    request.user = { userId: '123e4567-e89b-12d3-a456-426614174000', roles: ['Passenger', 'Parcel_Clerk', 'Depot_Manager'] };
    return true;
  }
}
"""
...
print("Parcel Service Phase 1 Scaffolded (DTOs, Enums, Guards, Prisma)")
